...
public class _TqsStackTest {
    ...
    void testPushBeyondCapacityThrowsException() {
        TqsBoundedStack<Integer> stack = new TqsBoundedStack<>(2);
        stack.push(1);
        stack.push(2);
        assertThrows(IllegalStateException.class, () -> stack.push(3), "Adicionar além da capacidade deve lançar exceção");
    }
    ...
    void testPopTopN() {
        ...
        assertEquals(3, stack.popTopN(1)); // Remove e retorna o elemento no topo
        assertEquals(1, stack.popTopN(2)); // Remove os próximos 2 elementos e retorna o último removido
    }
